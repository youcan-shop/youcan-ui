...
import type { IconPosition, TypeOfButton } from '~/components/Ybutton/button.types';
...
<template>
  <button
    ...
    :class="{ 'flip-order': hasIcon && props.iconPosition === 'right', [typeOfButton]: typeOfButton, 'disabled': disabled }"
  >
