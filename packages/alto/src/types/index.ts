...
export type { DividerProps, Thickness, Orientation } from '../components/Divider/types';
...
export type { LoaderProps, BrandLoadingProps, BarLoadingProps, SpinnerProps } from '../components/Loader/types';
